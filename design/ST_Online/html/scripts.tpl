<script>
	...
	// Замена битых
	$("img").error(function () {
		$(this).unbind("error").attr("src", "/design/{$settings->theme}/images/staticSheets/loading_xs.gif");
		$(this).attr("src", "/design/{$settings->theme}/images/staticSheets/loading_xs.gif");
